...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size, num_embd, block_size, dropout):
        super().__init__()
...
class Block(nn.Module):
    ...
    def __init__(self, num_embd, num_heads,block_size, dropout):
        ...
        self.self_attention = MultiHeadAttention(num_heads, head_size, num_embd, block_size, dropout)
...
class BigramLanguageModel(nn.Module):
    def __init__(self, vocab_size, num_embd, num_heads, num_layers, block_size, dropout, device):
        super().__init__()
        ...
        self.blocks = nn.Sequential(*[Block(num_embd, num_heads, block_size, dropout) for _ in range(num_layers)])
